...
void loop() {
  ...
  // Bridge holding registers between Server1 and Server2
  bridge.bridgeRegisters(0x0000, 0x0000); // Example: Bridge holding registers starting from address 0x0000 between Server1 and Server2
